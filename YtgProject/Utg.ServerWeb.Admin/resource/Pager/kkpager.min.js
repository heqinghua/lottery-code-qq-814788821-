		...
		generPageHtml : function(config,enforceInit){
			...
			if(this.isGoPage){
				gopage_info = '<span class="goPageBox">'+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'">'+
					'&nbsp;<input type="text" id="' + this.gopageTextboxId + '" onfocus="kkpager.focus_gopage()"  onkeypress="return kkpager.keypress_gopage(event);"    value="' + this.next + '" />&nbsp;</span>' + this.lang.gopageAfterText + '</span>' +
