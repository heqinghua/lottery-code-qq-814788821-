<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Played.aspx.cs" Inherits="Utg.ServerWeb.Admin.pages.Lottery.Played" %>
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <%
                                ...
                                %>
                                     <a href="/pages/Lottery/Played.aspx?lotteryCode=<%=mLotteryCode %>" class="<%=SetActive(mLotteryCode) %>" target="main"><%=mLotteryName %></a>
                                <% }
                                %>
                        </div>
                    </div>
                                        ...
                                        <tbody id="body-content">
                                            <asp:Repeater ID="repList" runat="server">
                                                <ItemTemplate>
                                                        ...
                                                        <td><asp:CheckBox ID="cBox" ToolTip='<%#Eval("PlayTypeRadioId")%>' runat="server"  Checked='<%#(bool)Eval("radioIsEnable") %>' /></td>
                                                        <td>
