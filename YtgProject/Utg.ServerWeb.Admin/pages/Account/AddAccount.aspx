<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAccount.aspx.cs" Inherits="Utg.ServerWeb.Admin.pages.Manager.AddAccount" %>
...
<body>
    <form id="Form1" runat="server" method="post" data-bv-message="This value is not valid"
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header" >新增管理用户</h2>
            </div>
            <!-- /.col-lg-12 -->
        </div>
