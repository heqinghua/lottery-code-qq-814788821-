<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRole.aspx.cs" Inherits="Utg.ServerWeb.Admin.pages.Role.EditRole" %>
    ...
    <form id="Form1" runat="server" method="post" data-bv-message="This value is not valid"
        ...
        <table class="fromtable">
            <tr>
                ...
                <td class="contentTd">
                    <p class="help-block">
                        <asp:TextBox ID="txtRoleName" runat="server" CssClass="form-control autoBox" required data-bv-notempty-message="角色名称不能为空"
                            data-bv-stringlength-max="16" data-bv-stringlength-message="角色名长度不能超过15个字符"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;角色名称长度不能超过15个字符.
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td class="contentTd">
                    <p class="help-block">
                        <asp:TextBox ID="txtDescript" runat="server" CssClass="form-control autoBox" required data-bv-notempty-message="描述不能为空"
                            data-bv-stringlength-max="100" data-bv-stringlength-message="描述长度不能超过15个字符"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;描述长度不能超过100个字符.
                    </p>
                </td>
            </tr>
        </table>
