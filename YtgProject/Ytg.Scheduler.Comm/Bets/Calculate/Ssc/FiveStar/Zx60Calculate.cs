...
{
    /// <summary>
    /// 五星/五星组选/组选60 20160117
    /// </summary>
    public class Zx60Calculate : ZhiXuanFushiDetailsCalculate
    {
        /// <summary>
        /// 计算具体中奖情况
        /// </summary>
        ...
        public override int TotalBetCount(BasicModel.LotteryBasic.BetDetail item)
        {
            ...
            foreach (var er in array[0])
            {
                ...
                if (fcount < 3)
                    continue;
                count += CombinationHelper.Cmn(fcount, 3);
            }
        ...
        private int TotalBet(BasicModel.LotteryBasic.BetDetail betDetail, string openResult)
        {
            ...
            foreach (var er in erChongHao)
            {
                ...
                if (danItems.Length < 3)
                    continue;
                Combinations<string> cx = new Combinations<string>(danItems, 3);
        ...
        {
            string res = "";
            var array=string.Format("{0}{1}{2}{3}{3}", c[0], c[1], c[2], er).OrderBy(x=>x);
