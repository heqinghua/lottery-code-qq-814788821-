...
{
    /// <summary>
    /// 后二/后二组选/组选单式 验证通过 2015/05/24 2016 01 18
    /// </summary>
    public class HeZuXuanDanShiCalculate : ZhiXuanDanShiDetailsCalculate
    {
        protected override void IssueCalculate(string issueCode, string openResult, BasicModel.LotteryBasic.BetDetail item)
        {
            ...
            if (openResult.Length == 5)
                res = openResult.Remove(0, 3);
            else
                res = openResult.Remove(0, 1);
