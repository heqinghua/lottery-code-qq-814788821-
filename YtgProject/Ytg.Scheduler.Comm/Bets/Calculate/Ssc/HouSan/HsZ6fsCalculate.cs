...
{
    /// <summary>
    /// 后三/后三组选/组六复式 验证通过 2015/05/23 2016 01 18
    /// </summary>
    public class HsZ6fsCalculate : ZhiXuanFushiDetailsCalculate
    {
        //todo 还需要继续写的
        /// <summary>
        /// 计算中奖情况
        ...
        protected override void IssueCalculate(string issueCode, string openResult, BasicModel.LotteryBasic.BetDetail item)
        {
            ...
            string housan = string.Empty;
            if (openResult.Length == 5)
                housan = openResult.Remove(0, 2);
            else
                housan = openResult;
