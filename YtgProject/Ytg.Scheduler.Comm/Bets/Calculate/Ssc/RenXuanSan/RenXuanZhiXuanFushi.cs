    ...
    public class RenXuanZhiXuanFushi : BaseRenXuan
    {
        protected override void IssueCalculate(string issueCode, string openResult, BasicModel.LotteryBasic.BetDetail item)
        {
            ...
            else
            {
                ...
                bool isWin = false;
                var list = GetAllBets(contentArray[0], contentArray[1], contentArray[2]);
        ...
        /// </summary>
        /// <returns></returns>
        private List<string> GetAllBets(string c0, string c1, string c2)
        {
            ...
            list = (from s in shi
                    from g in ge
                    from t in three
                    select string.Format("{0}{1}{2}", s, g, t)).ToList();
            return list;
        }
        ...
        public override int TotalBetCount(BasicModel.LotteryBasic.BetDetail item)
        {
            ...
            return contentArray[0].Length * contentArray[1].Length * contentArray[2].Length;
        }
