...
namespace Ytg.ServerWeb.Page
{
    ...
    public class UploadHandler : IHttpHandler
    {
        ...
        private void UpdateBannerImage(HttpContext context)
        {
            ...
            string oldFileName = context.Request.QueryString["oldFileName"].ToString();
            string newfileName = context.Request.QueryString["filename"].ToString();

            //删除图片
            if (oldFileName != newfileName)
                DelImage(context.Server.MapPath(savePath + oldFileName));
        ...
        public void DelBannerImage(HttpContext context)
        {
            ...
            DelImage(context.Server.MapPath(savePath + fileName));
        }
