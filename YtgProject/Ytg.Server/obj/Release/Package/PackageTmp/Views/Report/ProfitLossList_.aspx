<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfitLossList_.aspx.cs" Inherits="Ytg.ServerWeb.Views.Report.ProfitLossList" MasterPageFile="~/Views/Report/Report.master" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#lbtnSearch").click(function () {
                parUserId = $("#userCode").val().trim() == "" ? parUserId : $("#userCode").val().trim();
                loaddata();//加载数据
            });
        ...
        function loaddata(account) {
            ...
            $.ajax({
                ...
                type: 'post',
                data: "action=selectprofitlossslist1&startTime=" + st + "&endTime=" + ed + "&account=" + (account == undefined ? $("#userCode").val() : account),
                success: function (data) {
                    ...
                    if (jsonData.Code == 0 && jsonData.Data.length > 0) {
                        ...
                        for (var i = 0; i < jsonData.Data.length; i++) {
                            ...
                            if (item.Code == parUserId ) {
                                //移除
                                var pitem = item;
                               // console.info(JSON.stringify(item));
                                //var fsitem = jsonData.Data[0];
                                //jsonData.Data[0] = pitem;
                                //arr.splice(0, 0, pitem)
                                jsonData.Data.splice(i, 1);
                                jsonData.Data.splice(0, 0, item)

                                //jsonData.Data.push(fsitem);
                                break;
                            }
                        }

                        //console.info(JSON.stringify(jsonData.Data));
                        ...
                        $(".ltbody").children().last().children().css("color","red");
                    } else {
                        $(".ltbody").Empty(9);
                    }
                }
    ...
    <div class="control">
        ...
        <div class="toolbar-wrap">
            <table  border="0" cellspacing="0" cellpadding="0" >
                <tbody>
                    <tr>
                        <td style="text-align:right;">时间：</td><td >
                        ...
                        <td style="text-align:right;">用户：</td><td><input type="text" id="userCode" class="input " /></td>
