<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayConfim.aspx.cs" Inherits="Ytg.ServerWeb.Views.pay.zhifu.PayConfim" MasterPageFile="/Views/ChongZhi/ChongZhi.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="usersHead" runat="server">
    ...
    <style  type="text/css">
        .submit {
    background: url(/Views/pay/mobao/images/rechange.gif) left top no-repeat;
    width: 84px;
    height: 34px;
    border: 0;
    cursor: pointer;
