<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GamePk10.aspx.cs" Inherits="Ytg.ServerWeb.Lottery.GamePk10" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        /* PK10 style*/
        .lottery_frame .hc_history .cai_co ul li.haoma1 {
            padding-left: 0px;
        }

            .lottery_frame .hc_history .cai_co ul li.haoma1 span {
                width: 15px;
                height: 16px;
                line-height: 16px;
                text-align: center;
        ...
        .lottery_frame .hc_open .num_open ul li {
            background: url(/Css/pk10/pk10.png) no-repeat;
            width: 35px;
            height: 35px;
            float: left;
            margin-right: 1px;
            ...
            .lottery_frame .hc_open .num_open ul li span {
                display: block;
                line-height: 35px;
                text-align: center;
                color: #fff;
        ...
        .lottery_frame .hc_open .num_open .ssc_open {
    ...
    <script type="text/javascript">
        ...
        function processCode(issue, code, iscurent){
            ...
            if (iscurent == 2){//增加动态抓取
                var latestlot = "<ul ><li class=\"qihao1\">" + issue + "<\/li><li class=\"haoma1\" title='"+code+"' style='cursor: pointer;'>";
                var sCode = "";
                ...
                if (times){
                    (function(i, num){
                        ...
                        window.setTimeout(function(){
                            ...
                            $('.num_open ul li').eq(i).css({"left" : 1 * i + "px"}).fadeIn();
                        }, 50 * (aTmp.length - i), i, num);
                    ...
                    <div class="hc_open" >
                        ...
                        <div class="num_open">
                            <ul class="ssc_open">
                                ...
                                <li><span class="each"><span id="last_code_num5">★</span></span></li>
                                <li><span class="each"><span id="last_code_num6">★</span></span></li>
                                <li><span class="each"><span id="last_code_num7">★</span></span></li>
                                <li><span class="each"><span id="last_code_num8">★</span></span></li>
                                <li><span class="each"><span id="last_code_num9">★</span></span></li>
                            </ul>
                            <div class="ad" id="ad"></div>
                        </div>
                        <div class="num_type" style="display: none;">
                    ...
                    <div class="bg clearfix">
                        ...
                        <div class="box">
                            ...
                            <div class="Contentbox" id="lotteryDetail">
                                ...
                                <div class="" style="position: relative; display:none; *display: inline; margin-left: 8px;"><span id="nfdprize"></span></div>
                            </div>
                        </div>
