...
//下面是北京快乐吧
		...
		//	pmodel = stemp;
            ...
            //CLIVE添加投注内容时候的东西要修改
			var cfhtml = '<tr class="table_line"><th width="60%"> ' + nohtml + ' </th><td width="5%">[' + $.lt_method_data.modes[modes].name + ']</td><td width="12%">' + nums + lot_lang.dec_s1 + '</td><td width="10%">' + times + lot_lang.dec_s2 + '</td><td width="10%">' + money + lot_lang.dec_s3 + '</td><td class="del" width="45"><span><img src="/Content/Images/skin/btn_08.jpg"></span><input type="hidden" name="lt_project[]" value="' + serverdata + '" /></td></tr>';
            var $cfhtml = $(cfhtml);
