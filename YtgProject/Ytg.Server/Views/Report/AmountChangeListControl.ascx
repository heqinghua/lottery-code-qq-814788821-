<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AmountChangeListControl.ascx.cs" Inherits="Ytg.ServerWeb.Views.Report.AmountChangeListControl" %>
...
<script type="text/javascript">
    ...
    function openDetails(relevanceNo) {
        ...
        if (relevanceNo[0] == "b" || relevanceNo[0] == "i" || relevanceNo[0] == "h") {
            openHeight = 520;
        } else {
            //追号详情
...
<div class="toolbar-wrap">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable xk_input_head" style="display:none;">
        <tbody>
            <tr>
                <td rowspan="5" style="padding-left: 5px !important; width: 100px;">
            ...
            <tr>
                ...
                <td style="text-align: right; display: none;">玩法：</td>
                <td style="display: none;">
                    <select id="selPlayTypes">
                        <option selected="selected" value="-1">所有玩法</option>
                    </select>
                </td>
                <td style="text-align: right;">奖期：</td>
                <td>
                    <select id="selIssue">
            ...
            <tr>
                <td style="text-align: right;">快速查询：
                </td>
                <td colspan="5">
                    <div class="l-list">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td style="text-align: right;">查询时间：</td>
            <td colspan="5">
            ...
            <td style="width: 130px;">
                <input type="text" id="userCode" class="input normal" style="width: 120px;" /></td>
