<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayIndex.aspx.cs" Inherits="Ytg.ServerWeb.Views.pay.zhifu.PayIndex" MasterPageFile="/Views/ChongZhi/ChongZhi.master" enableEventValidation="false"%>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span >&nbsp;&nbsp;(单笔充值限额：最低：<span id="loadmin" class="red"> <%=Min %></span> 元，最高：<span id="loadmax" class="red"> <%=Max %></span> 元，微信扫码最高：<span style="color:red;"> 5000 </span>元)</span></td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <ul class="bank-list"  style="margin-top:10px;">
                                    ...
                                    <li>
                                        <input type="radio" name="bankCode" class="radio-img-bank" value="wechart"  tag="微信扫码支付"><div class="radio-img-cft"></div>
                                    </li>
