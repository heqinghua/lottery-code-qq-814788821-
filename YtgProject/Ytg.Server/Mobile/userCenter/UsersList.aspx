<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersList.aspx.cs" Inherits="Ytg.ServerWeb.Mobile.userCenter.UsersList" %>
   ...
   <meta name="apple-mobile-web-app-capable" content="yes">
    ...
    <script type="text/javascript">
       ...
       function recharge(uid,name) {
           ...
           //});
           saveTitleCookie();
           window.location="/Mobile/userCenter/Recharge.aspx?id="+uid+"&name="+name;
       }
       ...
       function recovery(uid,name,playType,bate_) {
           ...
           //加载数据
           saveTitleCookie();
           window.location="/Mobile/userCenter/Recovery.aspx?uid="+uid+"&name="+name;
       }
       ...
       function userpoins(uid) {
           window.location="/Mobile/userCenter/OpenQuota.aspx?uid=" + uid;
       }
       function quoclose(){
       ...
       function add_points(uid,name,bate_){
           ...
           saveTitleCookie();
           window.location="/Mobile/usercenter/UserPoints.aspx?uid="+uid+"&name="+name;
       }
            ...
            <div class="toolbar-wrap">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable xk_input_head">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input class="xk_dl_input" type="text" name="userCode" id="userCode" value="" style="width:80px;"></td>
                            <td style="text-align: right;">余额：</td>
                            <td>
                                <input class="xk_zd_input" name="txtStart" id="txtStart" value="" onkeyup="validate(this)" type="text" size="10" style="width:50px;">
                                至
                                <input class="xk_zd_input" name="txtend" id="txtend" value="" onkeyup="validate(this)" type="text" size="10" style="width:50px;">
                            </td>
                        ...
                        <tr>
                            <td align="center" colspan="<%=RowSpan %>">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grayTable">
                    <thead>
                        <tr>
                            <th  tag="Code">账号</th>
                            <th  tag="UserType">类型</th>
                            <th  tag="UserAmt">余额</th>
                            <th  tag="Rebate" id="userfandian">返点</th>
