...
var minbili = 10 / 100;
function hemaimonery(totalmonery) {
    totalmonery = parseFloat(totalmonery);
    $("#game_tzallmon").html(totalmonery);
    $("#hidgame_tzallmon").val(totalmonery);
    if (totalmonery <= 0) {
        $("#game_total_fen").html(0);
        $("#share_cnt").val(0);
    }
    else {
        $("#game_total_fen").html((totalmonery * minbili).toFixed(0));
